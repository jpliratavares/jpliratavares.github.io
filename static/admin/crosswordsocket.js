...
$(function () {
    ...
    connection.onopen = function () {
        $('#status').html("Enter the password to start the game.");
	$('#statusline2').html("<form action=\"javascript:register()\"><input type=\"password\" id=\"registername\"/><input type=\"button\" onclick=\"register()\" value=\"Start!\" />")
    };
...
function register(){
	connection.send("startGame "+$('#registername').val());
	return false;
}
